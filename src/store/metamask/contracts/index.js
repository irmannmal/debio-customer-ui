...
export default {
  ...
  actions: {
    initContracts({ commit, rootState }) {
      ...
      const EscrowContract = new web3.eth.Contract(Escrow.abi, getEnv("VUE_APP_DEBIO_ESCROW_ETH_ADDRESS"))
      ...
      case "DAI":
        ...
        break
      default:
        contractAddress = getEnv("VUE_APP_DEBIO_ERC20_INTERFACE_ADDRESS")
        break
      }
