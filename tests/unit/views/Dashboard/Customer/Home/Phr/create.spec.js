...
import CustomerPHRCreate from "@/views/Dashboard/Customer/Home/Phr/Create"
...
describe("Customer PHR Dashboard Create", () => {
  let container
  let localVue = null
  ...
  it("Should render", () => {
    CustomerPHRCreate.methods = {
      initialDataKey: jest.fn(), 
      fetchCategories: jest.fn() 
    };
    container = shallowMount(CustomerPHRCreate, {
      localVue,
      vuetify: new Vuetify(),
